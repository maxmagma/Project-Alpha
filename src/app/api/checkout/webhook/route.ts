/**
 * DISABLED: Stripe Webhook Handler
 *
 * This webhook handler is currently disabled as the platform has transitioned
 * to an affiliate + lead generation model. No payment processing happens through
 * the platform.
 *
